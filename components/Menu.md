...
<div class="bg-[#1b1b1b] rounded-lg border border-white/10">
  <div class="p-2 flex-col w-[340px]">
    ...
    >
      <p class="px-1 font-sans text-[14px] font-semibold">
    ...
    placeholder="Find projects..."
      class="px-2 bg-[#171616] text-white p-1 border border-white/10 w-full rounded-md outline-none ring-2 ring-blue-500/0 focus:ring-blue-500"
    />
  </div>
